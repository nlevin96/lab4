...
void simple_system(char *command) {
    ...
    if (0 == pid) {
        ...
        /* Parent's code */
        system_call(SYS_WAIT4, pid, 0, 0, 0);
    }
}
 ...
 * This means that 10 digits are enough + 1 char for the terminating '\0' + 1
 * char for '-'. in case of xtoa, it is 8 hex digits + 2 for the "0x" prefix.
 */
...
/*
Return the int value of the positive integer written in the string str or -1 on
errors. Doesn't support negative integers or non-decimal formats.
*/
